...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 1 --manuf-id 0x121c --image-type 5137 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL NPD4404_12_5AInlineRelay"':
        sys.exit(0)
    print " "
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 1 --manuf-id 0x121c --image-type 5137 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL NPD4404_12_5AInlineRelay"'.replace("\t", "\\t")
